...
BATTERY_WARNINGS_AND_PROTECTIONS_KEYS_DESCRIPTION = \
{
    ...
    "cell overvoltage protection"                  : "cell overvoltage protection",
    "cell undervoltage warning"                    : "cell undervoltage warning",
    "cell undervoltage protection"                 : "cell undervoltage protection",
